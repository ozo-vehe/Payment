//  Payment Details JS Code Starts Here
let userCardName = document.querySelector(".cardName input"),
    userCardNumber = document.querySelector(".cardNumber input"),
    userCardExpDate = document.querySelector(".cardExpDate input"),
    userCardCVV = document.querySelector(".cardCVV input"),
    userCardNameLabel = document.querySelector(".cardName label"),
    userCardNumberLabel = document.querySelector(".cardNumber label"),
    payBtn = document.querySelector("form button"),
    paymentStatus;
...
userCardName.addEventListener("focus", () => {slideUp(userCardName, userCardNameLabel);})
userCardName.addEventListener("blur", function () { slideDown(userCardName, userCardNameLabel, "Card Name") })

userCardNumber.addEventListener("focus", () => {slideUp(userCardNumber, userCardNumberLabel);})
userCardNumber.addEventListener("blur", function () { slideDown(userCardNumber, userCardNumberLabel, "***** ***** *****") })
...
/*********   Check If All Input Field Are FIlled    ****/
  if(userCardName.value && userCardNumber.value && userCardCVV.value && userCardExpDate.value) {
    paymentStatus = "success";

    /*****Create Local Storage For Successful Payment*****/
    localStorage.setItem('paymentStatus', JSON.stringify(paymentStatus));

    /*Redirect To The Payment Successful Page If Payment Is Successful*/
    ...
    /*Redirect To The Payment Failed Page If Payment Fails*/
    location.href = "paymentPage.html";
  }
})


//  Payment Details JS Code Ends Here
